...
import pandas as pd 
data = pd.read_csv('./data/result/PSSM/bc202f.csv')
y = data['label']
X = data.loc[:,'APAAC1':]
...
bc202ftrain = pd.DataFrame()

X_train.insert(0,'label',y_train)
bc202ftrain=X_train
bc202ftrain.to_csv('./data/result/PSSM/bc202ftrain.csv')

bc202ftest = pd.DataFrame()
X_test.insert(0,'label',y_test)
bc202ftest=X_test
bc202ftest.to_csv('./data/result/PSSM/bc202ftest.csv')


# ## SVM
# In[59]:
data = pd.read_csv('./data/result/PSSM/bc202ftrain.csv')
y = data['label']
X = data.loc[:,'APAAC1':]
...
paramArray2=[]
paramArray3=[]
aa=open('./data/result/PSSM/bc202f_evalution','a')
aa.write("\n\n\n\n-------------------SVM------------------------\n")
...
data = pd.read_csv('./data/result/PSSM/bc202ftest.csv')
yy = data['label']
XX = data.loc[:,'APAAC1':]
